...
class Complejo(object):
    ...
    def dividir(self, otro):
        result = Complejo(((self.real * otro.real) + (self.imag* otro.imag))/((otro.real * otro.real) + (otro.imag* otro.imag)), ((-self.real * otro.imag) + (self.imag*otro.real))/((otro.real * otro.real) + (otro.imag* otro.imag)))
        return result
...
class TestComplejo(unittest.TestCase):
    ...
    def test_multiplicar(self):
        ...
        self.assertEqual(multiplicar.real, 4)
        self.assertEqual(multiplicar.imag, 12)
    ...
    def test_dividir(self):
        ...
        self.assertEqual(dividir.real, (3/8))
        self.assertEqual(dividir.imag, (-1/8))
